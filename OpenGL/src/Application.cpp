...
int main() { 
...

	{
		...
		std::vector<Texture> tex = {
			Texture("diffuse", "resources/textures/grass.jpg", GL_LINEAR, GL_REPEAT),
			Texture("specular", "resources/textures/nospec.jpg", GL_LINEAR, GL_REPEAT)
		};
		...
		std::vector<Texture> boxtex = {
			Texture("diffuse", "resources/textures/box.png", GL_LINEAR, GL_REPEAT),
			Texture("specular", "resources/textures/box_specular.png", GL_LINEAR, GL_REPEAT)
		};
		...
		std::vector<Texture> hudtex = {
			Texture("hud", "resources/textures/crosshair.png", GL_LINEAR, GL_CLAMP_TO_EDGE)
		};
		...
		std::vector<Texture> lamptex = {
			Texture("diffuse", "resources/textures/sea_lantern.png", GL_NEAREST, GL_CLAMP_TO_EDGE),
		};
		...
		Shader hudshader("resources/shaders/hud.shader");
		...
		Shader basic("resources/shaders/basic.shader");
		basic.EnableBlending();

		//Setting Lighting Attributes

		Shader lampShader("resources/shaders/lightcube.shader");
		...
		Texture T7("diffuse", "resources/textures/flashlight.png", GL_LINEAR, GL_CLAMP_TO_BORDER);
		T7.Bind(7);
